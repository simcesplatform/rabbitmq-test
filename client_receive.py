...
async def start_receiver(host: str, port: int):
    """
    ...
    # do not allow the receiver program to exit before at least 5 messages have been received from the message bus
    ...
    LOGGER.info("Receiver: Closing the connection to the message bus.")
    await client.close()
