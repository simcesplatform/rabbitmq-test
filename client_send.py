...
from messages import MessageGenerator, StatusMessage
...
async def start_sender(host: str, port: int) -> None:
    """
    ...
    LOGGER.info("Sender: Closing the connection to the message bus.")
    await client.close()
