...
from datetime_tools import get_utcnow_in_milliseconds, to_iso_format_datetime_string
...
from message.block import QuantityArrayBlock, QuantityBlock, TimeSeriesBlock
    ...
    def _check_quantity_array_block(cls, value: Union[List[float], QuantityArrayBlock,
        ...
        if isinstance(value, dict):
            if not QuantityArrayBlock.validate_json(value):
                return False
            value = QuantityArrayBlock(**value)  # pyright: ignore: reportGeneralTypeIssues=false
